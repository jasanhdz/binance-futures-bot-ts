...
// The historical YAML checkpoint (18c858...) remains a preflight blocker, not replaced approval.
// See MICRO_CONTEXTUAL_V3_2026_09_08.md and the explicit config-drift denial regression.
