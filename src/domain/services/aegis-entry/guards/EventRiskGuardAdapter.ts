...
import { AegisEventRiskOverlay, AegisEventRiskOverlayDecision } from '../../AegisEventRiskOverlay';
...
export class EventRiskGuardAdapter {
    static evaluate(context: AegisEntryContext, policy: AegisEntryGuardPolicy): EventRiskGuardAdapterResult {
        ...
        const guard: AegisEntryGuardResult = {
            ...
            decision: wouldBlock ? (enforced && decision.allowed !== true ? 'DENY' : 'SHADOW_DENY') : 'ALLOW',
