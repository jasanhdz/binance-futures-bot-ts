...
import { AegisMicroLiveGateDecision } from '../services/AegisMicroLiveGate';
import {
  AegisEntryQualityGateCandle,
  AegisEntryQualityGateConfig,
  AegisEntryQualityGateDecision,
  AegisEntryQualityGateMode,
} from '../services/AegisEntryQualityGate';
import {
  AegisEventRiskOverlayConfig,
  AegisEventRiskOverlayDecision,
  EventRiskMode,
} from '../services/AegisEventRiskOverlay';
import {
...
export function guardDisabledResult(
  name: AegisEntryGuardName,
  reason = `${name}_disabled`,
