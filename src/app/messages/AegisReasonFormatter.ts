const REASON_LABELS: Record<string, string> = {
  ...
  long_risk_probe_long_critical:
    'Probe LONG bloqueado por LongRisk CRITICAL: EntryQuality insuficiente + EventRisk/CleanEntry débil + régimen/contexto no confirma',
};
