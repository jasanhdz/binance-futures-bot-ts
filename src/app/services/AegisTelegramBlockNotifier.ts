...
type NormalizedBlockNotificationInput = Required<
  Pick<AegisBlockNotificationInput, 'timestamp' | 'symbol' | 'side' | 'reason'>
> &
...
function normalizeConfig(
  config: Partial<AegisBlockNotificationConfig>,
): AegisBlockNotificationConfig {
  return {
...
function formatChange(
  previous: NormalizedBlockNotificationInput,
  current: NormalizedBlockNotificationInput,
): string {
