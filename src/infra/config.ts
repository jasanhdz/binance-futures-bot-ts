...
export const CONFIG = {
  ...
  STACKC_TIMEFRAME: (process.env.STACKC_TIMEFRAME as '3m' | '5m' | '15m' | '1h') ?? '5m',
  STACKC_TREND_TIMEFRAME: (process.env.STACKC_TREND_TIMEFRAME as '5m' | '15m' | '1h' | '4h') ?? '15m',
  STACKC_VOL_AVG_LEN: Number(process.env.STACKC_VOL_AVG_LEN ?? 20),
  STACKC_ENTRY_EMA_PERIOD: Number(process.env.STACKC_ENTRY_EMA_PERIOD ?? 20),
  STACKC_TREND_EMA_PERIOD: Number(process.env.STACKC_TREND_EMA_PERIOD ?? 50),
  STACKC_ENTRY_MAX_EXTENSION: Number(process.env.STACKC_ENTRY_MAX_EXTENSION ?? 0.004),
  STACKC_CLIMAX_BODY_PCT: Number(process.env.STACKC_CLIMAX_BODY_PCT ?? 0.75),
  STACKC_CLIMAX_VOL_FACTOR: Number(process.env.STACKC_CLIMAX_VOL_FACTOR ?? 2.2),
  STACKC_ENTRY_MAX_STREAK: Number(process.env.STACKC_ENTRY_MAX_STREAK ?? 6),
  STACKC_RETEST_LOOKBACK: Number(process.env.STACKC_RETEST_LOOKBACK ?? 30),
