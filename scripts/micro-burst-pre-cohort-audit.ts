...
const identity = createMicroBurstIdentity(git('rev-parse', 'HEAD'));
const mutationAuditAvailable = existsSync(
  resolve(root, 'src/infra/telegram/TelegramMutationAuditWriter.ts'),
);
