import {
  renderE4EntryMaeStudyMarkdown,
  runE4EntryMaeStudy,
} from '../../src/tooling/aegis/e4EntryMaeStudyCore';
...
async function main(): Promise<void> {
  ...
  if (args.includes('--help') || args.includes('-h')) {
    console.log(
      'Usage: npm run study:e4-entry-mae -- [--from ISO] [--to ISO] [--logs-dir DIR] [--out-dir DIR] [--no-reports]',
    );
    return;
  }
